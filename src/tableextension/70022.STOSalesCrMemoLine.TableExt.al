tableextension 70022 "STO Sales Cr.Memo Line" extends "Sales Cr.Memo Line"
{
    fields
    {
        ...
        field(70005; "PTA Deal ID"; Integer)
        {
            Caption = 'Deal ID';
            DataClassification = CustomerContent;
            BlankNumbers = BlankZero;
    ...
    keys
    {
        key(PTA; "PTA Deal ID", "PTA Vendor ID", "PTA Purch. Currency ID")
        {
        }
